...
- Calculate and interpret minimum, maximum, median, p90, p95, and p99 latency.
...
The scenario measures **ClearVerify and HeritageCore workflow dependencies**. Averages hide the few slow calls that can dominate an experience; dependency timing alone does not prove abandonment.
...
This formerly planned scope is now implemented as ClearVerify and HeritageCore workflow dependencies. All vendors, operations, observations, members, and metrics are fictional and synthetic.

## Metrics to measure

- minimum, maximum, median, p90, p95, and p99 latency.
...
The planned exercise is fulfilled by `scripts/analyze_api_latency.py` and its reusable implementation. No real REST, SOAP, payment, identity, or core service is contacted.
...
Averages hide the few slow calls that can dominate an experience; dependency timing alone does not prove abandonment.
