...
- Calculate and interpret common success, error taxonomy, attempt, vendor, operation, and duration telemetry.
...
The scenario measures **ClearVerify REST and HeritageCore SOAP adapters**. Harbor-owned adapters isolate protocol vocabulary and make unlike dependencies consistently observable and testable.
...
This formerly planned scope is now implemented as ClearVerify REST and HeritageCore SOAP adapters. All vendors, operations, observations, members, and metrics are fictional and synthetic.

## Metrics to measure

- common success, error taxonomy, attempt, vendor, operation, and duration telemetry.
...
The planned exercise is fulfilled by `scripts/compare_integrations.py` and its reusable implementation. No real REST, SOAP, payment, identity, or core service is contacted.
...
Harbor-owned adapters isolate protocol vocabulary and make unlike dependencies consistently observable and testable.
...
[Previous chapter](chapter-12-timeouts-retries-and-the-cost-of-resilience.md) | [Contents](../../CONTENTS.md) | [Next chapter](chapter-14-holding-vendors-accountable-with-evidence.md)
